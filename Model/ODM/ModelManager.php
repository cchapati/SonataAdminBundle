...
class ModelManager implements ModelManagerInterface
{
     ...
     *
     * @param string $name
     * @return \Doctrine\ODM\Mapping\ClassMetadata
     */
     ...
     * @param string $name
     * @param array $options
     * @return \Sonata\AdminBundle\Admin\ODM\FieldDescription
     */
    ...
    /**
     * @param string $alias
     * @return \Doctrine\ODM\MongoDB\Builder a query instance
     */
    ...
    {
        if (!$this->getdocumentManager()->getUnitOfWork()->isInIdentityMap($entity)) {
            throw new \RuntimeException('Entities passed to the choice field must be managed');
        }

        return $this->getdocumentManager()->getUnitOfWork()->getEntityIdentifier($entity);
    }
